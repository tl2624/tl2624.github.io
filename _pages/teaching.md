...
<style>
/* Tighter vertical rhythm for the teaching list (this page only) */
.page__content h3 { margin-top: 1em; margin-bottom: 0.3em; }
.page__content ul { margin-top: 0.3em; margin-bottom: 0.3em; }
.page__content li { margin-bottom: 0.15em; }
.page__content > p { margin: 0.35em 0; }
</style>
...
- **Political Systems of Africa** (PSC 23800). Political Science, City College of New York (CCNY), CUNY. S18. [Syllabus](https://tl2624.github.io/files/PSC_23800.pdf)

*Note: S = Spring, F = Fall, Su = Summer (e.g., F24 = Fall 2024).*
