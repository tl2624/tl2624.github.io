...
% No bibliography: this guide cites nothing directly. It states the framework only
% as far as its proofs require and points to the setup guide, which carries the
% citations for the potential outcomes schedule and SUTVA. Restore the block below
% if a citation is ever added here.
% \begin{singlespace}
